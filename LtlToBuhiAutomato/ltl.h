...
public:
  ...
  const bool isBinary() const { return _lhs != nullptr && _rhs != nullptr; }
...
inline bool Formula::operator==(const Formula& rhs) const {
    auto lhs = *this;
    return (
            (
             (lhs._lhs == nullptr && rhs._lhs == nullptr) ||
             ((lhs._lhs != nullptr && rhs._lhs != nullptr) &&
              ((*lhs._lhs) ==  (*rhs._lhs)))
             ) &&
             (
              (lhs._rhs == nullptr && rhs._rhs == nullptr) ||
              ((lhs._rhs != nullptr && rhs._rhs != nullptr) &&
               ((*lhs._rhs) ==  (*rhs._rhs)))
              ) &&
            (lhs._kind == rhs._kind) &&
